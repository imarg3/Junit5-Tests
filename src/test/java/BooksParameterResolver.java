...
public class BooksParameterResolver implements ParameterResolver {
    ...
    /**
     *
     * @param parameterContext - It contains the details of the parameter being asked for
     * @param extensionContext - It contains the context of the current test. Each test execution creates its own
     *                         ExecutionContext. The context contains details like test method, id, and so on.
     * @return
    ...
    public boolean supportsParameter(ParameterContext parameterContext, ExtensionContext extensionContext) throws ParameterResolutionException {
        ...
        return Objects.equals(parameter.getParameterizedType().
                getTypeName(), "java.util.Map<java.lang.String, org.model.Book>");
    }
